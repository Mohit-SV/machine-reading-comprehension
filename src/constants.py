...
# Constants needed for creation of Visual SQuAD dataset
...
V_SQUAD_DIR = os.path.join(SRC_DIRECTORY, "outputs", "squad", "dataloader_pr_data")
DOC_LIMIT = None
ZIP_PATH = os.path.join(SRC_DIRECTORY, "outputs", "squad", "dataloader_pr_data.zip")
